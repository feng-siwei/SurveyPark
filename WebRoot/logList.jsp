...
<html>
	...
	<body>
		...
		<table>
			...
			<tr>
				<td colspan="10" class="tdPHeaderR"><s:a action="LogAction_findAllLogs" namespace="/">全部日志</s:a></td>
			</tr>
			<tr>
				<td colspan="10" style="height: 5px"></td>
			</tr>
		...
		<s:else>
			<table>
				<thead>
					...
					<tr>
						<td colspan="10" class="tdHeader">最近两个月的日志:</td>
					</tr>
					<tr>
				...
				<tbody>
					<s:iterator value="allLogs" status="st">
						<tr>
							...
							<td>
								<span title='<s:property value="operParams"/>'><s:property value="getDescString(operParams)"/></span>
							</td>
							<td>
								<s:property value="operResult"/>
							</td>
							<td>
								<span title='<s:property value="resultMsg"/>'><s:property value="getDescString(resultMsg)" /> </span>
							</td>
							<td>
